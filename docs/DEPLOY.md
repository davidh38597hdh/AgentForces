...
```
https://agentxforce.com/api/auth/callback/google
...
1. Import `davidh38597hdh/AgentxForce` (or your fork).
2. Set env vars in the Vercel project.
3. Deploy. Domain: [agentxforce.com](https://agentxforce.com).
...
# one-time
fly auth login
fly apps create agentxforce   # or edit app name in fly.toml

fly secrets set \
  AUTH_SECRET="$(openssl rand -base64 32)" \
  AUTH_URL="https://agentxforce.fly.dev" \
  NEXT_PUBLIC_APP_URL="https://agentxforce.fly.dev" \
