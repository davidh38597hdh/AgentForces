...
|---|---|---|---|---|
| **Active product** | AgentForce | `~/code/AgentxForce` | **active** | `@chief-agentforce` |
...
|---|---|---|
| `@chief-agentforce` · `agentforce:` · `af:` · `chief-agentforce:` | Chief / coordinator | active |
